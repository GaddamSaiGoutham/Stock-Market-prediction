...
model.add(LSTM(22,input_shape=(11,11),activation='sigmoid',return_sequences=True))
model.add(LSTM(15,activation='sigmoid',return_sequences=False))
...
b = d[0:4073]
print np.array(output_array).shape 

output_array1 = np.array(output_array).reshape(4073,1,1)
#print output_array1.shape 
#print d1.shape
#print output_array1[0][4872]
d1 = np.array(b).reshape(4073,11,1)
model.fit(d1,output_array,epochs=15,batch_size=20)
